...
import com.dynastymasra.tour.model.LowPassFilter;
import com.dynastymasra.tour.model.Matrix;
...
public class SensorsActivity extends Activity implements SensorEventListener, LocationListener {
    ...
    public void onStart() {
        ...
        xAxisRotation.set(1f, 0f, 0f, 0f, (float) Math.cos(angleX), (float) -Math.sin(angleX), 0f, (float) Math.sin(angleX),
        ...
        try {
            ...
            try {
                try {
                    ...
                    else onLocationChanged(ARData.HARD_FIX);
                } catch (Exception ex2) {
                    onLocationChanged(ARData.HARD_FIX);
                }
                ...
                synchronized (magneticNorthCompensation) {
                    ...
                    magneticNorthCompensation.set((float) Math.cos(angleY), 0f, (float) Math.sin(angleY), 0f, 1f, 0f, (float) -Math.sin(angleY),
