package com.dynastymasra.tour.untility;

import android.location.Location;
import com.dynastymasra.tour.model.Vector;
...
public class PhysicalLocationUtility {
	...
	public static synchronized void convLocationToVector(Location org, PhysicalLocationUtility gp, Vector v) {
		if (org==null || gp==null || v==null) throw new NullPointerException("Location, PhysicalLocationUtility, and Vector cannot be NULL.");
