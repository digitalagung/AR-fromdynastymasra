...
import com.dynastymasra.tour.model.CameraSurface;
import com.dynastymasra.tour.model.Marker;
import com.dynastymasra.tour.model.VerticalSeekBar;
import com.dynastymasra.tour.view.AugmentedView;
...
public class AugmentedActivity extends SensorsActivity implements OnTouchListener {
    ...
    public static final float MAX_ZOOM = 100;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        FrameLayout.LayoutParams frameLayoutParams = new FrameLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,
                                                                                    Gravity.END);
